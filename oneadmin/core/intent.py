...
INTENT_LIST_LOGS_NAME = INTENT_PREFIX + "list_logs"
...
def built_in_intents() -> List[Text]:
    return [INTENT_REBOOT_SYSTEM_NAME, INTENT_GET_SYSTEM_TIME_NAME, INTENT_FORCE_GARBAGE_COLLECTION_NAME, INTENT_GET_SYSTEM_STATS_NAME, INTENT_GET_MEMORY_STATS_NAME, INTENT_GET_CPU_STATS_NAME, 
            ...
            INTENT_DOWNLOAD_FILE_NAME, INTENT_BROWSE_FILE_SYSTEM_NAME, INTENT_INVOKE_ON_TARGET_NAME, INTENT_RESTART_TARGET_NAME, INTENT_LIST_TARGETS_NAME, INTENT_STOP_TARGET_NAME, INTENT_START_TARGET_NAME, INTENT_SUBSCRIBE_CHANNEL_NAME, 
            ...
            INTENT_SEND_MAIL_NAME, INTENT_START_SCRIPT_EXECUTION_NAME, INTENT_STOP_SCRIPT_EXECUTION_NAME, INTENT_TEST_NAME, INTENT_WRITE_LOG_CHUNKS_NAME, INTENT_BOT_NOTIFY_NAME, INTENT_LIST_LOGS_NAME]
