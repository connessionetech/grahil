...
class CowinAutomation(IModule):
    ...
    def find_schedule(self, url, phonenumber, pincode, email_server_username, email_server_password, snapshot_name:str):
        ...
        try:
            ...
            self.logger.debug("Starting headless chrome...")
            ...
            self.logger.debug("Loading CoWIN website...")
            ...
            self.logger.debug("Entering phone number to request OTP...")
            ...
            self.logger.debug("OTP received! Enter OTP...")            
            ...
            sleep(5)
            self.logger.debug("Preparing to look for available schedules")
            ...
            sleep(5)            
            self.logger.debug("Entering desired pincode " + pincode + " to look for specific centers")            
            ...
            self.logger.debug("Capturing available appointment schedule")
            sleep(5)
